...
public class VegetableDAL {
    ...
    public boolean deleteVegetable(Vegetable v)
    {
        ...
        List<Vegetable> od = odDAL.loadVegetable();
        for(Vegetable odd  : od){
                //if(odd.getCategory().getName().contains("Fruit")){
                    System.out.println("CatagoryID: "+ odd.getVegetableName());
                    System.out.println("Name: "+ odd.getVegetableID());
                    System.out.println("Category Name: "+ odd.getCatagory().getName());
                //}
